...
namespace fredyns\attachment\components;

use himiklab\colorbox\Colorbox;
use fredyns\attachment\behaviors\FileBehavior;
 ...
 * Time: 19:10
 */
class AttachmentTableWithPreview extends Widget
{
    use ModuleTrait;
    ...
    public function run()
    {
        if (!$this->model) {
            return Html::tag('div',
                Html::tag('b',
                    Yii::t('yii', 'Error')) . ': ' . $this->getModule()->t('attachment', 'The model cannot be empty.'
                ),
                [
        ...
        if (!$hasFileBehavior) {
            return Html::tag('div',
                Html::tag('b',
                    Yii::t('yii', 'Error')) . ': ' . $this->getModule()->t('attachment', 'The behavior FileBehavior has not been attached to the model.'
                ),
                [
                    'class' => 'alert alert-danger'
                ]
...
JS;
        ...
        return GridView::widget([
            ...
            'columns' => [
                ...
                [
                    'label' => $this->getModule()->t('attachment', 'File name'),
                    'format' => 'raw',
                        ...
                        'delete' => function ($url, $model, $key) {
                            return Html::a('<span class="glyphicon glyphicon-trash"></span>',
                                ...
                                [
                                    ...
                                    'data-url' => Url::to(['/attachment/file/delete', 'id' => $model->id])
                                ]
                            );
                        }
                    ],
